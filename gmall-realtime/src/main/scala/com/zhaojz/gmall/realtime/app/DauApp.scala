package com.zhaojz.gmall.realtime.app
...
import com.zhaojz.gmall.common.constant.GmallConstants
import com.zhaojz.gmall.common.util.MyEsUtil
import com.zhaojz.gmall.realtime.bean.StartUpLog
import com.zhaojz.gmall.realtime.util.{MyKafkaUtil, RedisUtil}
    ...
    def main(args: Array[String]): Unit = {
        ...
        startuplogFilterDistinctDstream.foreachRDD{rdd=>
            ...
            val startupLogList: List[StartUpLog] = startupLogItr.toList
                ...
                MyEsUtil.insertEsBulk(GmallConstants.ES_INDEX_DAU,startupLogList)
